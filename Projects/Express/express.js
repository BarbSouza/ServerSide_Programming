...
//  Some logic to phandle the process 
//  Of sending and recieving imformation 
...
// INSERT INTO `mysql_db`.`mysql_table` (`full_name`, `email`, `gender`, `password`) VALUES ('Tom', 'Tom', 'AA', 'Meh');
        ...
        connection.query(sql, [firstname, lastname, userType, password], function(err,results){
            ...
            if(err){
                ...
                return res.send("Err: Could not insert information in the database");
...
app.listen("3000", function(){
    ...
    //connect to a database and give the status
